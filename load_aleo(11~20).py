...
async def main(connection):
    ...
    if window is not None:
                ...
                if session03 is not None:
                    ...
                    if session04 is not None:
                        ...
                        if session05 is not None:
                            await session05.async_split_pane(vertical=True, before=False, profile="aleo020")
        ...
        if session04 is not None:
            await session04.async_split_pane(vertical=True, before=False, profile="aleo019")
    else:
